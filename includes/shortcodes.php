...
/**
 * Legacy Salient shortcode stub — suppress output from old product content.
 *
 * Usage (legacy): [nectar_btn text="..." url="..."]
 */
function va_nectar_btn_noop( $atts, $content = null ) {
  return '';
}
add_shortcode( 'nectar_btn', 'va_nectar_btn_noop' );
