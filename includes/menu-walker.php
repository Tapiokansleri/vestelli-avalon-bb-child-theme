...
class VA_Menu_Walker extends Walker_Nav_Menu {
  ...
  public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
    ...
    // Detect mobile menu (so we can add level class + use unified mobile markup)
    ...
    if ( $is_mobile_menu ) {
      // Mobile: every item uses the same shape — wrapper > link [+ toggle button]
