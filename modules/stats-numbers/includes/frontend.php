...
$button_target = ! empty( $settings->button_target ) ? $settings->button_target : '_self';
$button_style  = ! empty( $settings->button_style ) ? $settings->button_style : 'light-blue';
$has_button    = $show_button && $button_text !== '' && $button_link !== '';
...
<div class="avalon-stats-wrapper" data-module-id="<?php echo esc_attr( $module->node ); ?>">
  ...
  <?php if ( ! empty( $subtitle_text ) ) : ?>
    <div class="avalon-stats-subtitle"><?php echo wp_kses_post( wpautop( $subtitle_text ) ); ?></div>
  <?php endif; ?>

  <?php if ( $has_button ) : ?>
    <div class="avalon-stats-cta">
      <a class="fl-button"
         href="<?php echo esc_url( $button_link ); ?>"
         target="<?php echo esc_attr( $button_target ); ?>"
         <?php echo $button_target === '_blank' ? 'rel="noopener noreferrer"' : ''; ?>>
        <span class="fl-button-text"><?php echo esc_html( $button_text ); ?></span>
