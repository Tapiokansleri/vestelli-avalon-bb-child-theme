    ...
    'sections' => array(
      'settings' => array(
        ...
        'fields' => array(
          ...
          'subtitle_text' => array(
            'type'        => 'textarea',
            'label'       => __( 'Otsikon alla oleva teksti', 'vestelli' ),
            'default'     => '',
            'rows'        => 3,
            'help'        => __( 'Näytetään otsikon alapuolella. Jätä tyhjäksi piilottaaksesi.', 'vestelli' ),
          ),
        ),
      ),
      'cta' => array(
        'title'  => __( 'Painike (CTA)', 'vestelli' ),
        'fields' => array(
          'show_button' => array(
            'type'        => 'select',
            'label'       => __( 'Näytä painike', 'vestelli' ),
            'default'     => 'no',
            'options'     => array(
              'yes' => __( 'Kyllä', 'vestelli' ),
              'no'  => __( 'Ei', 'vestelli' ),
            ...
            'toggle'      => array(
              'yes' => array(
                'fields' => array( 'button_text', 'button_link', 'button_target', 'button_style' ),
              ),
            ),
          ),
          'button_text' => array(
            'type'        => 'text',
            'label'       => __( 'Painikkeen teksti', 'vestelli' ),
            'default'     => __( 'Lue lisää', 'vestelli' ),
          ),
          'button_link' => array(
            'type'        => 'link',
            'label'       => __( 'Painikkeen linkki', 'vestelli' ),
            'default'     => '',
          ),
          'button_target' => array(
            'type'        => 'select',
            'label'       => __( 'Linkin kohde', 'vestelli' ),
            'default'     => '_self',
            'options'     => array(
              '_self'  => __( 'Sama välilehti', 'vestelli' ),
              '_blank' => __( 'Uusi välilehti', 'vestelli' ),
            ),
          ),
          'button_style' => array(
            'type'        => 'select',
            'label'       => __( 'Painikkeen tyyli', 'vestelli' ),
            'default'     => 'light-blue',
            'options'     => array(
              'light-blue'    => __( 'Vaaleansininen', 'vestelli' ),
              'default'       => __( 'Tummansininen', 'vestelli' ),
              'bordered-blue' => __( 'Reunallinen', 'vestelli' ),
            ),
          ),
        ),
      ),
